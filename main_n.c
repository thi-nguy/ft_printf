...
//	printf("%d\n\n", printf("16pointeur 1 %.6p pointeur 2 %.6p\n\n", &c, &c));
	...
	// printf("J'affiche des %ncaracteres.", n);
...
// // cspdiuxX%
// // combinaison de flags ’-0.*’ et la taille de champ minimale
...
// 	//FLAG ESPACE 
// 	//version : ignorer espace 
// 	//si % doit avoir un type sinon warning	
// printf("%-       i\n", -12);
// printf("\n");
// printf("%-       i\n", -12);
...
// main.c:19:11: warning: flag '0' results in undefined behavior with 'c' conversion specifier [-Wformat]
//     //     printf("%05c", 'a');
//     //             ~^~~
// main.c:21:11: warning: flag '0' results in undefined behavior with 's' conversion specifier [-Wformat]
//     //     printf("%05s", "abc");
//     //             ~^~~
